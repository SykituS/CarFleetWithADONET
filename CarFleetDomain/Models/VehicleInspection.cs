...
namespace CarFleetDomain.Models
{
    public class VehicleInspection : ModelExtension
    {
        ...
        public static DataResponse GetVehicleInspectionQuery(DataSet dataSet, SqlCommand selectCmd = null)
        {
        ...
        public static DataResponse UpdateVehicleInspectionCommand(DataSet dataSet)
        {
            using (var connection = new SqlConnection(Context.ConnectionString))
            {
                try
                {
                    ...
                    adapter.UpdateCommand.Parameters.Add("@DateOfNextInspection", SqlDbType.DateTime).SourceColumn = "DateOfNextInspection";
                    adapter.UpdateCommand.Parameters.Add("@DateOfInspection", SqlDbType.DateTime).SourceColumn = "DateOfInspection";
        ...
        public static DataResponse InsertVehicleInspectionCommand(DataSet dataSet)
        {
            using (var connection = new SqlConnection(Context.ConnectionString))
            {
                try
                {
                    ...
                    adapter.InsertCommand.Parameters.Add("@DateOfNextInspection", SqlDbType.DateTime).SourceColumn = "DateOfNextInspection";
                    adapter.InsertCommand.Parameters.Add("@DateOfInspection", SqlDbType.DateTime).SourceColumn = "DateOfInspection";
